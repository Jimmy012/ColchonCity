                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>Precio Matrimonial</th>
                            <th>Precio Queen-Size</th>
                            <th>Precio King-Size</th>
                            <th>Visible</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td><img src="/tienda/productos/{{$product->image}}" width="40"></td>
                                <td>{{ $product->name }}</td>
                                <td>{{ $product->category->name }}</td>
                                <td>{{ $product->tipo->nombre }}</td>
                                <td>${{ number_format($product->price,2) }}</td>
                                <td>${{ number_format($product->precioMatri,2) }}</td>
                                <td>${{ number_format($product->precioQueen,2) }}</td>
                                <td>${{ number_format($product->precioKing,2) }}</td>
